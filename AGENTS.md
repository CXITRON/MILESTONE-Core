...
- Current firmware baseline: `5.1.0`
- Legacy firmware baseline: `3.3.4`
- V5 firmware baseline: `5.1.0` (`v5/`, dual-board MAIN/ZERO plus independent SAFE)
...
For v5, the same `milestone-release local 5.1.0` command selects the internal
