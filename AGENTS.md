...
- Current firmware baseline: `5.2.2`
- Legacy firmware baseline: `3.3.4`
- V5 firmware baseline: `5.2.2` (`v5/`, dual-board MAIN/ZERO plus independent SAFE)
...
For v5, the same `milestone-release local 5.2.2` command selects the internal
