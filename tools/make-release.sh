...
if (( $# < 1 || $# > 2 )); then
  ...
  echo "예: $0 2.2.21 'Route NOW artwork through the free cache gateway'" >&2
  exit 2
fi
...
ble_runtime_marker=MILESTONE_BLE_AMS_RUNTIME_V5
artwork_runtime_marker=MILESTONE_NOW_ARTWORK_RUNTIME_V2
