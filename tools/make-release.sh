...
if (( $# < 1 || $# > 2 )); then
  ...
  echo "예: $0 2.2.24 'Preserve BLE airtime during artwork TLS'" >&2
  exit 2
fi
...
ble_runtime_marker=MILESTONE_BLE_AMS_RUNTIME_V6
artwork_runtime_marker=MILESTONE_NOW_ARTWORK_RUNTIME_V4
