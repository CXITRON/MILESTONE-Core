# MILESTONE v5.0 개발 방향

> 상태: 설계 확정안, 별도 `v5/` 트리에서 구현 진행 중
>
> 작성 기준: 2026-09-01
>
> 현재 배포 기준인 v3.3.4의 동작이나 빌드 계약을 변경하는 문서가 아니다. 실제 v5.0 구현이 시작되면 소스, 테스트, 릴리스 문서와 함께 단계적으로 동기화한다.
