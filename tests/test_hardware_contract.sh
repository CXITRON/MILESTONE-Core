...
require 'setToneAdjustment' CoreTftDisplay.cpp 'runtime TFT tone adjustment is missing'
require 'id="display_luminance"' PortalPage.h 'portal luminance control is missing'
require 'id="display_contrast"' PortalPage.h 'portal contrast control is missing'
require 'display_luminance' CorePortal.inc 'portal luminance API field is missing'
require 'display_contrast' CorePortal.inc 'portal contrast API field is missing'
