...
require 'FIRMWARE_VERSION\[\] = "2\.2\.22"' MILESTONE_Core.ino 'firmware version is not 2.2.22'
...
require 'MILESTONE_NOW_ARTWORK_RUNTIME_V3' CoreArtwork.inc 'NOW artwork runtime marker missing'
