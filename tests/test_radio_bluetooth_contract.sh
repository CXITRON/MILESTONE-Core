...
require 'FIRMWARE_VERSION\[\] = "3\.3\.4"' MILESTONE_Core.ino 'firmware version is not 3.3.4'
...
require 'MILESTONE_NOW_ARTWORK_RUNTIME_V7' CoreArtwork.inc 'NOW color artwork runtime marker missing'
require 'NOW_ARTWORK_SERVICE_URL' MILESTONE_Core.ino 'NOW artwork gateway URL is missing'
require 'http://milestone-artwork\.typhoon-individual\.workers\.dev/v3/artwork' MILESTONE_Core.ino 'NOW color gateway HTTP URL is not configured'
