...
require_fixed tools/make-release.sh 'ble_runtime_marker=MILESTONE_BLE_AMS_RUNTIME_V5' 'release build does not verify the NOW BLE runtime implementation'
require_fixed tools/make-release.sh 'artwork_runtime_marker=MILESTONE_NOW_ARTWORK_RUNTIME_V4' 'release build does not verify the NOW artwork runtime implementation'
