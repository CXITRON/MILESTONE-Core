...
require_fixed tools/make-release.sh 'artwork_runtime_marker=MILESTONE_NOW_ARTWORK_RUNTIME_V5' 'release build does not verify the NOW artwork runtime implementation'
