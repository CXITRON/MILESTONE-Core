...
require_fixed tools/make-release.sh 'artwork_runtime_marker=MILESTONE_NOW_ARTWORK_RUNTIME_V3' 'release build does not verify the NOW artwork runtime implementation'
